<template>
  <div class="h-full 2xl:w-[65%] lg:w-[70%] md:w-[80%] md:m-auto">
    ...
    >
      <div v-for="(eventt, i) in event.events.events_ongoing" :key="i">
        <h1
          ...
          class="text-black font-bold text-4xl mx-auto"
        >
          {{ eventt.name }}
    ...
    <div class="flex flex-col lg:flex-row justify-between h-auto">
      <div class="basis-[80%] lg:order-none order-2">
        ...
        >
          <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-center w-[100%] text-center mx-auto">
              <div class="xl:w-[35%] lg:w-[40%] sm:w-[35%] w-[40%]">
                <select
                  v-model="participant"
                ...
                >
                  ...
                  <option value="0">Participant Type</option>
            ...
            <div class="grid grid-cols-2 mt-4 md:gap-6">
              <div>
                <label
                  for="address"
                  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
      ...
      <!----chart---->
      <div
        class="order-1 basis-[20%] lg:flex lg:justify-start lg:flex-col md:w-[90%] w-[75%] my-auto ml-6"
      >
        <div
          class="overflow-x-auto top-[10px] mb-10 relative flex justify-center shadow-lg shadow-indigo-400/80 px-5 border border-indigo-400/70"
        >
          <table
    ...
    <!-- data show the table -->
    <div
      class="h-auto py-2 md:py-6 xl:w-[100%] lg:w-[100%] md:w-[90%] md:mx-auto md:mb-7 sm:w-[75%] my-3 w-[75%] shadow-lg p-7 shadow-indigo-500/40 mx-auto sm:mb-8 mb-8"
    >
      <div>
        ...
        >
          ...
          <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              ...
              <td class="py-4 px-6 hidden md:block">300</td>
...
export default defineComponent({
  ...
  setup() {
    ...
    const submit = (e) => {
      ...
      dri_maid_fee.value =
        parseInt(drivarsquan.value) * 300 + parseInt(maidsquan.value) * 500;
      console.log(dri_maid_quan.value, dri_maid_fee.value);
      //guest
      ...
      axios
        ...
        .catch(function (error) {
          if (error.response) {
            if (
              error?.response?.data?.errors.phone === "The phone has already been taken."
            ) {
              e.preventDefault();
    ...
    const update = (e) => {
      ...
      dri_maid_fee.value = parseInt(driver.value) * 300 + parseInt(maid.value) * 500;
